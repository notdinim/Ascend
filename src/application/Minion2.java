...
// MINION 2 CLASS - POLYMORPHED BOSS 2 CLASS
public class Minion2 extends Boss2{
	...
	// CONSTRUCTOR
	public Minion2(double bossX, double bossY) {
		...
		imgMinionLeft = new Image("file:images\\enemies\\minion_2_left.png");
		imgMinionRight = new Image("file:images\\enemies\\minion_2_right.png");
