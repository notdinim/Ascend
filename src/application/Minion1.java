...
// MINION 1 CLASS - POLYMORPHED BOSS 1 CLASS
public class Minion1 extends Boss1{
	...
	// CONSTRUCTOR
	public Minion1(double bossX, double bossY) {
		...
		xPos = bossX;
		yPos = bossY;
		xSpeed = rnd.nextInt(3) + 3;
		minionDir = rnd.nextInt(2) + 1;
		explodeChance = rnd.nextInt(3) + 1;
		imgMinionLeft = new Image("file:images\\enemies\\minion_1_left.png");
		imgMinionRight = new Image("file:images\\enemies\\minion_1_right.png");
