...
// MINION 3 CLASS - POLYMORPHED BOSS 3 CLASS
public class Minion3 extends Boss3{
	...
	// CONSTRUCTOR
	public Minion3(double bossX, double bossY) {
		...
		xPos = bossX;
		yPos = bossY;
		xSpeed = rnd.nextInt(5) + 5;
		minionDir = rnd.nextInt(2) + 1;
		explodeChance = rnd.nextInt(2) + 1;
		imgMinionLeft = new Image("file:images\\enemies\\minion_3_left.png");
		imgMinionRight = new Image("file:images\\enemies\\minion_3_right.png");
